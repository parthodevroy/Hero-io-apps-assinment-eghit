      ...
      <div className="navbar-start pl-8">
        <div className="dropdown">
          ...
          <ul tabIndex={0} className="menu menu-sm dropdown-content bg-base-100 rounded-box z-1 mt-3 w-52 p-2 shadow">
            <li><NavLink to="/" className={({ isActive }) => isActive ? "border-b-2 font-semibold" : ""}>Home</NavLink></li>
            <li><NavLink to="/allapps" className={({ isActive }) => isActive ? "border-b-2 font-semibold" : ""}>Apps</NavLink></li>
            <li><NavLink to="/insapps" className={({ isActive }) => isActive ? "border-b-2 font-semibold" : ""}>Installation</NavLink></li>
          </ul>
        </div>
